-- CreateEnum
CREATE TYPE "ServiceType" AS ENUM ('HOME_INTERNET', 'HOTSPOT_WIFI', 'MOBILE_RECHARGE', 'ELECTRICITY_BILL', 'SET_TOP_BOX');

-- CreateEnum
CREATE TYPE "PackageStatus" AS ENUM ('ACTIVE', 'INACTIVE', 'DISCONTINUED');

-- CreateEnum
CREATE TYPE "ExecutionStatus" AS ENUM ('COMPLETED', 'FAILED', 'MAPPING_CLIENT', 'PENDING', 'PROCESSING', 'QUEUED', 'REFUNDED', 'RENEWING', 'VERIFYING');

-- CreateEnum
CREATE TYPE "OwnershipStatus" AS ENUM ('ACTIVE', 'EXPIRED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "CardStatus" AS ENUM ('AVAILABLE', 'USED');

-- CreateEnum
CREATE TYPE "ExecutionMethod" AS ENUM ('AUTOMATIC', 'MANUAL');
...
CREATE TABLE "stb_packages" (
    ...
    CONSTRAINT "stb_packages_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "stb_services" (
    "id" UUID NOT NULL,
    "user_id" UUID NOT NULL,
    "stb_number" VARCHAR(50) NOT NULL,
    "package_id" UUID NOT NULL,
    "status" "OwnershipStatus" NOT NULL DEFAULT 'ACTIVE',
    ...
    CONSTRAINT "stb_services_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "service_execution_logs" (
    ...
    "execution_method" "ExecutionMethod" NOT NULL DEFAULT 'AUTOMATIC',
    "error_message" TEXT,
...
CREATE TABLE "hotspot_cards" (
    ...
    CONSTRAINT "hotspot_cards_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "isp_client_map" (
    "id" TEXT NOT NULL,
    "clientId" TEXT NOT NULL,
    "subscriptionId" TEXT NOT NULL,
    "lastVerifiedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "isp_client_map_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "stb_services_user_id_idx" ON "stb_services"("user_id");

-- CreateIndex
CREATE INDEX "stb_services_stb_number_idx" ON "stb_services"("stb_number");

-- CreateIndex
CREATE INDEX "stb_services_status_idx" ON "stb_services"("status");

-- CreateIndex
CREATE INDEX "service_execution_logs_service_type_status_idx" ON "service_execution_logs"("service_type", "status");

-- CreateIndex
CREATE INDEX "service_execution_logs_service_record_id_idx" ON "service_execution_logs"("service_record_id");

-- CreateIndex
CREATE INDEX "service_execution_logs_wallet_transaction_id_idx" ON "service_execution_logs"("wallet_transaction_id");

-- CreateIndex
CREATE UNIQUE INDEX "hotspot_cards_code_key" ON "hotspot_cards"("code");

-- CreateIndex
CREATE INDEX "hotspot_cards_package_id_status_idx" ON "hotspot_cards"("package_id", "status");

-- CreateIndex
CREATE UNIQUE INDEX "isp_client_map_clientId_key" ON "isp_client_map"("clientId");

-- CreateIndex
CREATE UNIQUE INDEX "isp_client_map_subscriptionId_key" ON "isp_client_map"("subscriptionId");
...
-- AddForeignKey
ALTER TABLE "stb_services" ADD CONSTRAINT "stb_services_package_id_fkey" FOREIGN KEY ("package_id") REFERENCES "stb_packages"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "hotspot_cards" ADD CONSTRAINT "hotspot_cards_package_id_fkey" FOREIGN KEY ("package_id") REFERENCES "service_packages"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
